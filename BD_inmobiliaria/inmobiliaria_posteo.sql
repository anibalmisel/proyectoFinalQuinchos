...
CREATE TABLE `posteo` (
  ...
  UNIQUE KEY `propiedad_id_UNIQUE` (`propiedad_id`),
  UNIQUE KEY `usuario_id_UNIQUE` (`usuario_id`) /*!80000 INVISIBLE */
...
INSERT INTO `posteo` VALUES (1,1,1);
...
-- Dump completed on 2024-11-02 15:08:23
